import { Euler, Matrix3, Matrix4, Quaternion, Vector3, generateUUID } from '@renderlayer/math';
...
class Object3D extends EventDispatcher {
  ...
  rotateOnWorldAxis(axis, angle) {
    // rotate object on axis in world space axis is assumed to be
  ...
  toJSON(meta) {
    ...
    // extract data from the cache hash remove metadata on
    // each item and return as array
