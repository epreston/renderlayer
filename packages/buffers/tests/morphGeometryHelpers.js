...
import { Float32BufferAttribute } from '../src/BufferAttribute';
import { BufferGeometry } from '../src/BufferGeometry';

// box with 2 morph target influences
// mesh.morphTargetInfluences[0] = 0...1 (sphere)
// mesh.morphTargetInfluences[1] = 0...1 (twist)

/**
 * @returns {Mesh}
 */
export function createBoxMorphMesh() {
