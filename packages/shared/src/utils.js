 ...
 * display style set to 'block', which is commonly used in
 ...
 * and console.error calls made, which is useful for custom logging,
...
/**
 * Logs an informational message with the 'RL.' prefix.
 *
 ...
 * method name and is automatically prefixed with 'RL.'.
 *
 * @param {...any} params - The message components. The first param is used as
 *                          the method name and prefixed with 'RL.'.
 */
function log(...params) {
...
/**
 * Logs a warning message with the 'RL.' prefix.
 *
 * If a custom console function is set via setConsoleFunction(), it will be used
...
/**
 * Logs an error message with the 'RL.' prefix.
 *
 * If a custom console function is set via setConsoleFunction(), it will be used
...
/**
 * TypedArray, a union of typed array types.
 *
 * @typedef {Uint8Array | Int8Array |Uint8ClampedArray | Int16Array | Uint16Array |
 *           Int32Array | Uint32Array | Float32Array | Float64Array } TypedArray
 *
 * TypedArrayConstructor, a union typed array constructor types.
 *
 * @typedef {Int8ArrayConstructor | Uint8ArrayConstructor | Uint8ClampedArrayConstructor |
 *           Int16ArrayConstructor | Uint16ArrayConstructor |
 *           Int32ArrayConstructor | Uint32ArrayConstructor |
 *           Float32ArrayConstructor | Float64ArrayConstructor} TypedArrayConstructor
 */
